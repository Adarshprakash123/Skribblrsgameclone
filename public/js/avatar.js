...
const baseURL = 'https://api.dicebear.com/8.x/adventurer/svg?seed=Sophie';
const my = {
    name: localStorage.getItem('name') || '',
    avatar: localStorage.getItem('avatar') || 'https://api.dicebear.com/8.x/adventurer/svg?seed=Sophie',
};
